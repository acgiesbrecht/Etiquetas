 ...
 * @author Industria
 */
public class PanelSemillaManiFundacion extends javax.swing.JPanel {

    public PanelSemillaManiFundacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnPrint.setText("IMPRIMIR GRANDE FUNDACION");
        ...
        btnPrintSmall.setEnabled(false);
    ...
    private String getZpl() {
        ...
        String response = "^XA"
                ...
                + "^FT64,256^XGE:CCLOGO20.GRF,1,1^FS"
                + "^FO27,25^GB746,1100,1^FS"
                + "^FT321,157^A0N,38,39^FB379,1,0,C^FH\\^FDSEMILLA DE MANI^FS"
                + "^FT321,242^A0N,68,69^FB379,1,0,C^FH\\^FDFUNDACION^FS"
                ...
                + "^FT87,590^A0N,28,28^FH\\^FDFecha de Elaboracion:^FS"
        ...
        response += "^FT5,1034^A0N,23,24^FB799,1,0,C^FH\\^FDElaborado por Cooperativa Chortitzer Ltda.^FS"
                + "^FT5,1062^A0N,23,24^FB799,1,0,C^FH\\^FDTel. (0492) 418 600^FS"
